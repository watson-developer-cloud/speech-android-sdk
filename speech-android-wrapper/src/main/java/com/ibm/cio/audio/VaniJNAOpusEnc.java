 ...
 * JNI Speex encoder.
 */
public class VaniJNAOpusEnc implements VaniEncoder {
    // Use PROPRIETARY notice if class contains a main() method, otherwise use
    // COPYRIGHT notice.
    public static final String COPYRIGHT_NOTICE = "(c) Copyright IBM Corp. 2014";
    /** The Constant TAG. */
    private static final String TAG = VaniJNAOpusEnc.class.getName();
...
//		writer.writeHeader("Encoded with: " + JNAOpus.INSTANCE.opus_get_version_string());
     ...
     * @throws IOException
     */
    public void initEncoderWithWebSocketClient(VaniOpusUploader client) throws IOException{
//		this.client = client;
